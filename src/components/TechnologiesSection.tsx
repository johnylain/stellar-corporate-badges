...
const tabs = [
  {
    ...
    label: "Металлы",
    items: [
      { name: "Золото", detail: "375 / 585 / 750 проба" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Золочение", detail: "Гальваническое золочение 999 пробой" },
    ...
    <section className="section-padding">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="mb-16"
        >
          <p className="label-text gold-text mb-4 text-base">Технологии</p>
