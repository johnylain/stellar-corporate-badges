...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="section-padding light-section" style={{ backgroundImage: "url('/images/halftone-golden.avif')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundBlendMode: 'overlay' }}>
